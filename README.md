...
## v2ray-heroku
[![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/Hitgit685/marrycc.git)
...
![image](https://cdn.jsdelivr.net/gh/Hitgit685/marrycc/doc/1.png)

请求`/speedtest/`，html5-speedtest测速页面

![image](https://cdn.jsdelivr.net/gh/Hitgit685/marrycc/doc/2.png)

请求`/test/`，文件下载速度测试

![image](https://cdn.jsdelivr.net/gh/Hitgit685/marrycc/doc/3.png)
